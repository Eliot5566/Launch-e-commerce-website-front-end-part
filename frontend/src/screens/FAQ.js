  ...
  return (
    <>
      <div className="container fs-4 mt-5">
        <div
          className="fs-1 mb-5 text-center fw-bolder"
          style={{ color: '#9a2540' }}
        >
          常見問題&nbsp;FAQ
        </div>
        <div id="accordion">
          ...
          <div>
            <p>
              生銅鑼燒室溫下退冰10-15分、生大福室溫下退冰30分
              <br />
              部分商品可於冷凍狀態下享用，口感近似冰淇淋，冷藏保存期限為兩天，敬請趁鮮享用
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="25"
          ...
          <div>
            <p>
              本島宅配運費計算方式如下：
              <br />
              消費$1500元以下，運費$150、消費$1501-$3000元，運費$220、消費$3001元
              以上，免運費 (限同一地址)
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
          ...
          <div>
            <p>
              若手機有開啟阻擋廣告簡訊功能，則無法順利發送，您可來電或來信客服，將由專人協助您開通會員
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="25"
